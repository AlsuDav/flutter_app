...
mixin _$CatStore on _CatStore, Store {
  Computed<List<Cat>>? _$getFilteredCatsComputed;

  @override
  List<Cat> get getFilteredCats => (_$getFilteredCatsComputed ??=
          Computed<List<Cat>>(() => super.getFilteredCats,
              name: '_CatStore.getFilteredCats'))
      .value;
  ...
  String toString() {
    return '''
cats: ${cats},
getFilteredCats: ${getFilteredCats}
    ''';
  }
}
